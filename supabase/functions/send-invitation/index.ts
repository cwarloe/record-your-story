// Supabase Edge Function for sending email invitations
...
serve(async (req) => {
  ...
  try {
    ...
    // Create invitation token (for signup link)
    ...
    const signupLink = `${baseUrl}?invite=${invitationToken}`
      ...
      personalizations: [
        {
          ...
          subject: `${invitation.senderName} invited you to collaborate on "${invitation.eventTitle}"`,
        },
      ],
      from: {
              ...
              <body>
                <div class="container">
                  ...
                  <div class="content">
                    ...
                    <p><strong>${invitation.senderName}</strong> wants to share a memory with you: <strong>"${invitation.eventTitle}"</strong></p>
                    ...
                    <p style="margin-top: 30px; font-size: 14px; color: #666;">
                      If you already have an account, this link will automatically connect you to the shared timeline.
                    </p>
                  </div>
                  <div class="footer">
